...
\newcommand{\thesisKeywords}{ YOLOv8, Bot\_SortTracker, Roboflow,Region of Interest(ROI), Counting Algorithm.}
...
\newcommand{\thesisFirstAuthorBP}{Chiangmai, Thailand}
\newcommand{\thesisFirstAuthorHC}{Mahidol International College}
\newcommand{\thesisFirstAuthorTel}{061-819-1519}
...
\newcommand{\thesisSecondAuthorBP}{Phrae, Thailand}
\newcommand{\thesisSecondAuthorHC}{Mahidol International College}
\newcommand{\thesisSecondAuthorTel}{092-470-4640}
...
\newcommand{\thesisThirdAuthorID}{091-886-5554}
\newcommand{\thesisThirdAuthorBD}{02 August 2001}
\newcommand{\thesisThirdAuthorBP}{Bangkok, Thailad}
\newcommand{\thesisThirdAuthorHC}{Mahidol International College}
\newcommand{\thesisThirdAuthorTel}{091-886-5554}
...
%Advisor name
\newcommand{\thesisAdv}{Mingmanas Sivaraksa }  %with title name
...
\newcommand{\committeeIDegree}{Ph.D. (Communications and Integrated Systems)}
\newcommand{\committeeII}{Tanasanee Phienthrakul}
